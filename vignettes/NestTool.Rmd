...
trackingdata <- fread("03_milvus_combined.csv")
indseasondata <- fread("03_validation_combined.csv") %>%
...
The function `data_prep` calculates many values for each individual season and will take on average 2-5 seconds per individual season. For data sets with >100 individual seasons it will therefore take a few minutes for the function to complete.
