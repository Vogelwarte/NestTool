...
#'
#' @return Returns a list with 6 data.frames. \code{summary} contains one row per individual season and 45 variables, which each characterise movement metrics for a different period of the breeding season. Output data.frame includes age and sex information.
...
#' \code{movementtrack} contains a tibble with the raw movement data and a column 'tod_' indicating the time of day. Useful for function \code{movement_visualisation}.
#'
#'
#' @export 
