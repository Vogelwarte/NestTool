...
```{r ranging_graphic, echo=FALSE, out.height='80%', out.width='80%', fig.align="center", fig.cap="Permutation-derived variable importance of predictor variables to classify whether home range behaviour occurred"}
...
```{r nesting_graphic, echo=FALSE, out.height='80%', out.width='80%', fig.align="center", fig.cap="Permutation-derived variable importance of predictor variables to classify whether a nesting attempt occurred"}
...
```{r success_graphic, echo=FALSE, out.height='80%', out.width='80%', fig.align="center", fig.cap="Permutation-derived variable importance of predictor variables to classify whether a nesting attempt was successful"}
...
```{r move_graphic, echo=FALSE, out.height='80%', out.width='80%', fig.align="center", fig.cap="Seasonal trajectory of movement metrics of a focal individual to assist with manual classification"}
...
```{r shiny_graphic2, echo=FALSE, out.height='80%', out.width='80%', fig.align="center", fig.cap="Example of the entire Shiny App window to assist with manual classification of individual seasons"}
knitr::include_graphics("plots/shiny_app.png", dpi = 100)
```
