...
```{r shiny_graphic, echo=FALSE, out.height='80%', out.width='80%', fig.align="center", fig.cap="Example of the Shiny App to assist with manual classification of individual seasons"}
